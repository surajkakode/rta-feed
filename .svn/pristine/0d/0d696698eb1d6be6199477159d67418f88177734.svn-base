...
public class InvestorQuery {
    ...
    @FindBy(xpath = "//table[@class='TableCls contentcls']//select")
    private WebElement selectFund;

    @FindBy(xpath = "//table[@class='contentcls']//input[@value='ACNO' and @type='radio']")
    private WebElement accountNumberRadioButton;

    @FindBy(xpath = "//table[@class='contentcls']//input[contains(@name,'txtAcNo') and @type='text']")
    private WebElement accountNumberInputBox;

    @FindBy(xpath = "//table[@class='contentcls']//input[@value='Submit' and @type='submit']")
    private WebElement submitButton;

    @FindBy(xpath = "//tbody/tr[2]//a[contains(text(),'SOA')]")
